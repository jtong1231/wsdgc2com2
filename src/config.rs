...
pub const RENDEZVOUS_SERVERS: &[&str] = &["206.238.43.28"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 33426;
pub const RELAY_PORT: i32 = 33427;
pub const WS_RENDEZVOUS_PORT: i32 =33428;
pub const WS_RELAY_PORT: i32 = 33429;
