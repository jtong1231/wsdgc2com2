...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.211.96.71"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 37726;
pub const RELAY_PORT: i32 = 37727;
pub const WS_RENDEZVOUS_PORT: i32 =37728;
pub const WS_RELAY_PORT: i32 = 37729;
