...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("共联会".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.248.74.141"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 37126;
pub const RELAY_PORT: i32 = 37127;
pub const WS_RENDEZVOUS_PORT: i32 =37128;
pub const WS_RELAY_PORT: i32 = 37129;
