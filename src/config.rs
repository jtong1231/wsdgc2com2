...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("速视宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.248.74.149"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 38526;
pub const RELAY_PORT: i32 = 38527;
pub const WS_RENDEZVOUS_PORT: i32 =38528;
pub const WS_RELAY_PORT: i32 = 38529;
