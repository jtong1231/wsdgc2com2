...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.82.84.3"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 33126;
pub const RELAY_PORT: i32 = 33127;
pub const WS_RENDEZVOUS_PORT: i32 =33128;
pub const WS_RELAY_PORT: i32 = 33129;
