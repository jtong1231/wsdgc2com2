...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.211.97.55"];
pub const RS_PUB_KEY: &str = "YYy4QBgCfGDLI79kVRKLdZIzyCvL1KMb4+u5lZ5bmF0=";
pub const RENDEZVOUS_PORT: i32 = 38726;
pub const RELAY_PORT: i32 = 38727;
pub const WS_RENDEZVOUS_PORT: i32 =38728;
pub const WS_RELAY_PORT: i32 = 38729;
